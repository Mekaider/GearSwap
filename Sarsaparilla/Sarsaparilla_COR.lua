...
function user_setup()
    ...
    -- state.Gun = M{['description']='Gun', 'Ataktos', 'Fomalhaut', 'DeathPenalty'}
    state.Gun = M{['description']='Gun', 'Ataktos', 'Fomalhaut', 'Molybdosis'}
	state.WeaponSet = M{['description']='WeaponSet', 'Slashing', 'Piercing', 'Ranged', 'Rostam'}
    ...
    send_command('bind f11 gs c cycle Gun')
...
function init_gear_sets()
    ...
    -- Not used (currently assume max magic haste)
    sets.engaged.DW = {}

    -- 21% DW required at max haste without haste samba
    sets.engaged.DW.DNC = set_combine(sets.engaged, {
        -- 5 from Floral Gauntlets
        waist="Reiki Yotai", -- 7
        left_ear="Eabani Earring", -- 4
        right_ear="Suppanomimi", -- 5
        -- back={ name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+4','"Dual Wield"+10','Phys. dmg. taken-8%',}},
    })

    -- 9% DW required at max haste with haste samba (from sub)
    sets.engaged.DW.DNC.HasteSamba = set_combine(sets.engaged, {
        -- 5 from Floral Gauntlets
        left_ear="Eabani Earring", -- 4
    ...
    -- 11% DW required at max haste without haste samba (from sub)
    sets.engaged.DW.NIN = set_combine(sets.engaged, {
        -- 5 from Floral Gauntlets
        waist="Reiki Yotai",
        left_ear="Eabani Earring"
    })

    -- 1% over cap at max haste with haste samba (from sub)
    sets.engaged.DW.NIN.HasteSamba = sets.engaged
    ...
    sets.engaged.DW.DT.DNC = set_combine(sets.engaged, sets.Hybrid, {
        head="Malignance Chapeau",
        body="Malignance Tabard",
        hands="Malignance Gloves",
    ...
    sets.engaged.DW.DT.DNC.HasteSamba = set_combine(sets.engaged, sets.Hybrid, {
        left_ear="Eabani Earring", -- 4
        right_ear="Suppanomimi", -- 5 
    })

    sets.engaged.DW.DT.NIN = set_combine(sets.engaged, sets.Hybrid, {
        waist="Reiki Yotai",
        left_ear="Eabani Earring" 
    })
    sets.engaged.DW.DT.NIN.HasteSamba = set_combine(sets.engaged, sets.Hybrid)
    ...
    sets.Ranged = {main={ name="Kustawi +1", augments={'Path: A',}}, sub="Nusku Shield"}
    sets.Tauret = {main="Tauret", sub="Gleti's Knife"}
    sets.Rostam = {main={ name="Rostam", augments={'Path: B',}}, sub="Tauret"}
...
function determine_haste_group()
    ...
    if buffactive['haste samba'] or buffactive['haste daze'] then 
        classes.CustomMeleeGroups:append('HasteSamba')
    end
end