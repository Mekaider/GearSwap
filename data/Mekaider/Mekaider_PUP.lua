...
function user_setup()
    ...
    state.HybridMode:options("Normal", "TP", "DT")
   ...
   --[[
    ...
    state.textHideHUB = M(true, "Hide HUB")
    ...
    -- send_command("bind F9 gs c cycle PetModeCycle")
    -- -- send_command("bind ^f7 gs c cycleback PetModeCycle")
    -- -- send_command("bind F10 gs c cycle PetStyleCycle")
